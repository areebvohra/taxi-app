...
//       });
                                                                          ...
                                                                          children: [
                                                                            Row(
                                                                              children: [
                                                                                Text(
                                                                                  "Pick Up",
                                                                                  style: GoogleFonts.roboto(fontSize: 9, color: Colors.grey),
                                                                                  maxLines: 1,
                                                                                    ...
                                                                                    ? SizedBox(
                                                                                        ...
                                                                                        child: Row(
                                                                                          children: [
                                                                                            ...
                                                                                            Text(
                                                                                              "Edit",
                                                                                              style: GoogleFonts.roboto(fontSize: media.width * twelve, color: Colors.blueAccent),
                                                                                            ),
                                                                                            const SizedBox(
                                                                                              width: 5,
                                                                                            )
                                                                                    ...
                                                                                    return InkWell(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        decoration: BoxDecoration(
                                                                                          ...
                                                                                          color: (choosenVehicle != i) ? const Color.fromARGB(0, 77, 37, 255) : Colors.grey[200],
                                                                                        ),
                                                                                        child: Column(
                                                                                                ...
                                                                                                (etaDetails[i]['icon'] != null)
                                                                                                    ? Container(
                                                                                                        ...
                                                                                                        child:
                                                                                                            ...
                                                                                                            // ))
                                                                                                            SvgPicture.asset(
                                                                                                          getVehicleImage(etaDetails[i]['name']), fit: BoxFit.contain, // vehi
                                                                                                        ))
                                                                                                    : Container(),
                                                                                                (minutes[etaDetails[i]['type_id']] != '')
                                                                                                    ? Text(
                                                                                                ...
                                                                                                child: Container(
                                                                                                  ...
                                                                                                  child: Row(
                                                                                                    children: [
                                                                                                      Column(
                                                                                                        children: [
                                                                                                          (rentalOption[i]['icon'] != null) ? Container(width: media.width * 0.15, child: Image.asset("assets/images/call.png")) : Container(),
                                                                                                          (minutes[rentalOption[i]['type_id']] != "")
                                                                                                              ? Text(
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Center(
                                                                  child:
                                                                      SvgPicture
                                                                          .asset(
                                                                "assets/customized/schedule.svg",
                                                                height: media
                                                                        .height *
                                                                    0.05,
                                                              )
                                                            ...
                                                            GestureDetector(
                                                              ...
                                                              child: Container(
                                                                child: Center(
                                                                    child: SvgPicture
                                                                        .asset(
                                                                  "assets/customized/startTrip.svg",
                                                                  height: media
                                                                          .height *
                                                                      0.055,
                                                                )
  ...
  String getVehicleImage(String type) {
    if (type == "Express") {
      return "assets/images/sedan.svg";
    } else {
      return "assets/images/sedan.svg"; //vehi
    }
  }
